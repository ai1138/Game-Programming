...
#define LEVEL5_WIDTH 11
#define LEVEL5_HEIGHT 25
...
void Level5::Initialize() {
    ...
    state.enemy[2].position = glm::vec3(5, -18, 0);
    ...
    state.enemy[4].position = glm::vec3(6, -20, 0);
    ...
    state.enemy[5].position = glm::vec3(5, -21, 0);
...
void Level5::Render(ShaderProgram* program) {
    ...
    Util::DrawText(program, fontID, "Level 5", 0.5f, -0.25f, glm::vec3(state.player->position.x + 3, state.player->position.y + 3, 0));
    ...
    {
        Util::DrawText(program, fontID, "You Win!", 0.5f, -0.25f, glm::vec3(state.player->position.x - 3, state.player->position.y + 2, 0));
        state.gameDone = true;
    }
}
